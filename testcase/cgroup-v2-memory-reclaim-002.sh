#!/bin/bash
###############################################################################
# @用例ID: 20240806-202710-043353562
# @用例名称: cgroup-v2-memory-reclaim-002
# @用例级别: 2
# @用例标签: cgroup-v2 memory reclaim
# @用例类型: 测试memory.reclaim接口文件，回收匿名内存
###############################################################################
[ -z "$TST_TS_TOPDIR" ] && {
...
CGROUP="cgroup-v2-memory-reclaim-002"
